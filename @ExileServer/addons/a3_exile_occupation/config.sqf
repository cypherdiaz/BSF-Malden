...
SC_randomSpawnChance			= 6;						// Percentage chance of spawning if suitable player found
...
SC_randomSpawnFrequency			= 5200;						// time in seconds between the possibility of random AI hunting the same player (1800 for 30 minutes)
...
SC_LootCrateItems           	= [
									...
									["Exile_Item_Rope",0,1],
									["rzinfection_antivirus_pills",0,1],
...
SC_HeliCrashItems           	=   [
									...
									["rzinfection_antivirus_pills",1,2],
...
SC_VehicleClassToUse 			=   [	
									["rhsusf_mrzr4_w",0],
									["rhsusf_mrzr4_w_mud",0],
									["rhsusf_m998_w_4dr",0],
									["rhsusf_m998_w_2dr_halftop",0],
									["rhsusf_rg33_usmc_wd",0],
									["rhsusf_M1232_usarmy_w",0],		
									["rhs_tigr_vdv",2],									["Exile_Car_HEMMT",2],
									["Exile_Car_HEMMT",2],
									["Exile_Car_Hatchback_BlueCustom",0],
									["Exile_Car_Hatchback_BeigeCustom",0],
									["Exile_Car_Zamak",2],
									["Exile_Car_Offroad_Armed_Guerilla12",1],
									["Exile_Car_Tempest",2],									
									["Exile_Car_Offroad_Armed_Guerilla03",1],
									["Exile_Car_SUV_Armed_Black",2],
									["Exile_Car_BTR40_MG_Camo",1],
									["Exile_Car_BTR40_Green",0]
                                ];
SC_VehicleClassToUseRare		=   [	
									["rhsusf_M1232_M2_usarmy_wd",0]
									//["O_LSV_02_armed_F",1],
