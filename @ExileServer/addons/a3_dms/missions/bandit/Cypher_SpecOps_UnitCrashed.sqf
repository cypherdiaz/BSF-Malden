/*
	...
	Features:		
		...
		0 AI Static Weapon Emplacements
...
_crate_loot_values1 =
[
	(8 + (round (random 2))),		// Weapons
	(4 + (round (random 4))),		// Items
	(2 + (round (random 2))) 		// Backpacks
];
...
_msgStart = ['#FFFF00',"They crashed their helicopter! Not so special huh? Go take em out!"];

// Define Mission Win message
_msgWIN = ['#0080ff',"Nice job taking them out Convict! Take the remaining loot!"];

// Define Mission Lose message
_msgLOSE = ['#FF0000',"They managed to run away with all their stuff! You weren't fast enough Convict."];

// Define mission name (for map marker and logging)
_missionName = "SpecOps Unit Crashed";
