/*
	...
	Crate Info:
		...
		High Drop of Custom DMS_BoxTruckConst Loot List.
...
_building = createVehicle ["Land_Cargo_HQ_V2_F",[(_pos select 0) - 10, (_pos select 1),-0.1],[], 0, "CAN_COLLIDE"];
...
_msgStart = ['#FFFF00',"Hey! These idiots can't drive. They crashed their truck full of Construction supplies! Go take it off their hands!"];

// Define Mission Win message
_msgWIN = ['#0080ff',"Nice job claiming the construction supplies for your own Convict!"];

// Define Mission Lose message
_msgLOSE = ['#FF0000',"The tow truck showed up before you did! Everything is gone!"];

// Define mission name (for map marker and logging)
_missionName = "Construction Truck Crash";
