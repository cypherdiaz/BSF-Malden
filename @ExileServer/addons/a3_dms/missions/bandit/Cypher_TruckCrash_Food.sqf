/*
	...
	Crate Info:
		...
		High Drop of Custom DMS_BoxTruckFood Loot List.
...
_msgStart = ['#FFFF00',"Hey! These idiots can't drive. They crashed their truck full of Food supplies! Go take it off their hands!"];

// Define Mission Win message
_msgWIN = ['#0080ff',"Nice job claiming the food supplies for your own Convict!"];

// Define Mission Lose message
_msgLOSE = ['#FF0000',"The tow truck showed up before you did! Everything is gone!"];

// Define mission name (for map marker and logging)
_missionName = "Food Truck Crash";
